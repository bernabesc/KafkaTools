...
public class ApplicationWindow {
	...
	private void initialize() {
		...
		frmPostToKafka.addKeyListener(new KeyAdapter() {
			@Override
		...
		frmPostToKafka.setLocationRelativeTo(null);
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(!ipAddressTextField.getText().isEmpty()) {
					if(!TopicTextField.getText().isEmpty()) {
						try {
							KafkaSender sender = new KafkaSender(ipAddressTextField.getText());
							String json = new String(Files.readAllBytes(Paths.get(selectedFile.getAbsolutePath())));
							
							if(headerTextField.getText().isEmpty()) {
								sender.sendJson(TopicTextField.getText(),"",json,null);
							}else {
								sender.sendJson(TopicTextField.getText(),"",json,headerTextField.getText());
							}
